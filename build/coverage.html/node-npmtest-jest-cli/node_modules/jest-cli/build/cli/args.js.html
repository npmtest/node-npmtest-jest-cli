...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jest-cli/node_modules/jest-cli/build/cli/args.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jest-cli/node_modules/jest-cli/build/cli/args.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jest-cli/node_modules/jest-cli/build/cli/</a> &#187; args.js</div>
</div>
<div class="body">
...
&nbsp;
const check = argv =&gt; {
<span class="cstat-no" title="statement not covered" >  if (argv.runInBand &amp;&amp; argv.hasOwnProperty('maxWorkers')) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (argv.onlyChanged &amp;&amp; argv._.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error(</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (argv.onlyChanged &amp;&amp; argv.watchAll) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error(</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (argv.findRelatedTests &amp;&amp; argv._.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error(</span>
